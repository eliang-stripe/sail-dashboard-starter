...
export const Button = ({
  ...
  const variants = {
    primary: 'bg-blurple text-white border border-blurple hover:border-blurple disabled:opacity-50 disabled:hover:border-blurple shadow-[0px_1px_1px_0px_rgba(47,14,99,0.32)]',
